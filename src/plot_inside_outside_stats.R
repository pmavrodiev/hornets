...
setwd("/home/pmavrodiev/Documents/Hornets/output/")
...
CairoPDF(file="analysis-2014 Nest A gesamt.pdf",width=30,height=15)
par(mfrow=c(1,2))
...
axis(1,at=seq(0,500,by=20),label=seq(0,500,by=20),cex.axis=3,cex.lab=3)
axis(2,at=seq(0,0.4,by=0.05),label=seq(0,0.4,by=0.05),las=2,
     cex.axis=3,cex.lab=3)
mtext("duration (minutes)",side=1,line=5,cex=3)
mtext("frequency",side=2,line=9,cex=3)
title("Nest A - inside",cex.main=3)
...
text(x=320,y=0.374,labels="median",cex=3)
text(x=320,y=0.352,labels="mean",cex=3)
...
plot(mids,counts/sum(counts),xaxt="n",yaxt="n",xlab="",ylab="",type="s",lwd=3)
...
axis(1,at=seq(0,120,by=20),label=seq(0,120,by=20),cex.axis=3,cex.lab=3)
axis(2,at=seq(0,0.08,by=0.02),label=seq(0,0.08,by=0.02),las=2,cex.axis=3,cex.lab=3)
mtext("duration (minutes)",side=1,line=5,cex=3)
mtext("frequency",side=2,line=9,cex=3)
...
text(x=82,y=0.0532,labels="median",cex=3)
text(x=84,y=0.0503,labels="mean",cex=3)
...
text(x=82,y=0.0483,labels="median",cex=3)
text(x=84,y=0.0457,labels="mean",cex=3)
}
...
source("/home/pmavrodiev/Documents/Hornets/src/logarithmic_axes.R")
aY=seq(-4,0)
...
legend("topright",legend=c("empirical data",paste("exponential fit with rate ",
                                                  round(1/mean(outside.subset2),2),sep="")),
